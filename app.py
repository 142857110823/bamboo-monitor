"""
智眸识竹-基于遥感影像与随机森林的竹林资源智能监测与辅助养护系统 - 驾驶舱首页
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("智眸识竹-竹林资源智能监测与辅助养护系统 v1.0")

# ============ 页面标题 ============
# ============ 页面标题 ============
st.markdown("""
<h1 style="text-align: center; font-size: 3rem; margin-top: -1rem; margin-bottom: 0.5rem;">智眸识竹</h1>
<p style="text-align: center; font-size: 1.1rem; color: #888; margin: 0.8rem 0;">基于遥感影像与随机森林的竹林资源智能监测与辅助养护系统 | 王朗自然保护区</p>
...
with st.expander("系统使用指引", expanded=False):
    ...
    1. **数据上传与分析**: 在数据上传与分析页面上传GeoTIFF格式的双时相NDVI合成影像
    2. **查看分布图**: 分析完成后,前往交互式地图查看竹林分布的空间可视化结果
    3. **预警管理**: 在预警与任务页面查看系统自动识别的异常区域和巡护建议
    4. **数据导出**: 在数据导出页面下载分析结果和统计报表
...
with st.expander("了解我们", expanded=False):
    st.markdown("""
    ### 智眸识竹-基于遥感影像与随机森林的竹林资源智能监测与辅助养护系统
    ...
    ---
    *智眸识竹-竹林资源智能监测与辅助养护系统 v1.0 | 2024-2025*
    """)
